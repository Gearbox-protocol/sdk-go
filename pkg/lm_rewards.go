...
var poolRewardGIP68 map[string]*big.Int = map[string]*big.Int{
	"dDAI":    big.NewInt(2283),
	"dUSDC":   big.NewInt(3101),
	"dWETH":   big.NewInt(4014),
	"dWBTC":   big.NewInt(457),
...
var MainnetPoolRewards = PoolRewardSnapshots{{poolRewardv2, 15820000}, {poolRewardv2GIP30, 15977000}, {poolRewardFRAX, 16720000}, {poolRewardGIP68, 17904775}, {poolRewardGIPNext, 18815109}}
