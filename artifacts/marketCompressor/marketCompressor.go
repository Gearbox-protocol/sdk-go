...
// ZapperState is an auto generated low-level Go binding around an user-defined struct.
...
//
// Solidity: function getMarketData(address pool, address configurator) view returns((address,address,address,((address,uint256,bytes32,bytes),string,string,uint8,uint256,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,(address,uint256,uint256,uint256)[],uint256,uint256,uint256,uint40,uint40,bool),((address,uint256,bytes32,bytes),address,(address,uint16,uint192,uint16,uint96,uint96,bool)[],address[],uint40),((address,uint256,bytes32,bytes)),((address,uint256,bytes32,bytes),(address,uint16)[]),((address,uint256,bytes32,bytes),(address,bool,address,uint32)[],((address,uint256,bytes32,bytes),uint8,bool,bool,address[],uint32[],(int256,uint256,bool))[]),((address,uint256,bytes32,bytes)),(address,string,string,uint8)[],(((address,uint256,bytes32,bytes),address,address,address,bool,uint40,uint8,uint256,uint256,uint256,bool),((address,uint256,bytes32,bytes),string,address,address,address,address,address,uint8,(address,uint16)[],uint16,uint16,uint16,uint16,uint16),((address,uint256,bytes32,bytes)),((address,uint256,bytes32,bytes),address)[])[],address,address[],address[],address[],((address,uint256,bytes32,bytes),(address,string,string,uint8),(address,string,string,uint8))[]) result)
