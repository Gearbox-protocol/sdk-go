...
//
// Solidity: function getCreditAccountData(address _creditAccount, (address,bytes)[] priceUpdates) returns((bool,address[],address,address,address,address,address,uint256,uint256,uint256,uint128,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,(address,uint256,bool,bool,bool,uint256,uint16)[],uint64,uint256,uint40,address[],uint256,(uint8,uint40,address,uint256)[2]) result)
func (_DataCompressorv3 *DataCompressorv3Transactor) GetCreditAccountData(opts *bind.TransactOpts, _creditAccount common.Address, priceUpdates []PriceOnDemand) (*types.Transaction, error) {
	return _DataCompressorv3.contract.Transact(opts, "getCreditAccountData", _creditAccount, priceUpdates)
}

// GetCreditAccountData is a paid mutator transaction binding the contract method 0xe50b35ec.
//
// Solidity: function getCreditAccountData(address _creditAccount, (address,bytes)[] priceUpdates) returns((bool,address[],address,address,address,address,address,uint256,uint256,uint256,uint128,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,(address,uint256,bool,bool,bool,uint256,uint16)[],uint64,uint256,uint40,address[],uint256,(uint8,uint40,address,uint256)[2]) result)
func (_DataCompressorv3 *DataCompressorv3Session) GetCreditAccountData(_creditAccount common.Address, priceUpdates []PriceOnDemand) (*types.Transaction, error) {
	return _DataCompressorv3.Contract.GetCreditAccountData(&_DataCompressorv3.TransactOpts, _creditAccount, priceUpdates)
}

// GetCreditAccountData is a paid mutator transaction binding the contract method 0xe50b35ec.
//
// Solidity: function getCreditAccountData(address _creditAccount, (address,bytes)[] priceUpdates) returns((bool,address[],address,address,address,address,address,uint256,uint256,uint256,uint128,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,(address,uint256,bool,bool,bool,uint256,uint16)[],uint64,uint256,uint40,address[],uint256,(uint8,uint40,address,uint256)[2]) result)
func (_DataCompressorv3 *DataCompressorv3TransactorSession) GetCreditAccountData(_creditAccount common.Address, priceUpdates []PriceOnDemand) (*types.Transaction, error) {
	return _DataCompressorv3.Contract.GetCreditAccountData(&_DataCompressorv3.TransactOpts, _creditAccount, priceUpdates)
}
