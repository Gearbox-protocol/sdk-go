...
// GaugeVote is an auto generated low-level Go binding around an user-defined struct.
...
// GetCreditAccountData is a free data retrieval call binding the contract method 0xe50b35ec.
//
// Solidity: function getCreditAccountData(address _creditAccount, (address,bytes)[] priceUpdates) view returns((bool,address[],address,address,address,address,address,uint256,uint256,uint256,uint128,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,(address,uint256,bool,bool,bool,uint256,uint16)[],uint64,uint256,uint40,address[],uint256,(uint8,uint40,address,uint256)[2]) result)
func (_DataCompressorv3 *DataCompressorv3Caller) GetCreditAccountData(opts *bind.CallOpts, _creditAccount common.Address, priceUpdates []PriceOnDemand) (CreditAccountData, error) {
	var out []interface{}
	err := _DataCompressorv3.contract.Call(opts, &out, "getCreditAccountData", _creditAccount, priceUpdates)
...
//
// Solidity: function getCreditAccountData(address _creditAccount, (address,bytes)[] priceUpdates) view returns((bool,address[],address,address,address,address,address,uint256,uint256,uint256,uint128,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,(address,uint256,bool,bool,bool,uint256,uint16)[],uint64,uint256,uint40,address[],uint256,(uint8,uint40,address,uint256)[2]) result)
func (_DataCompressorv3 *DataCompressorv3Session) GetCreditAccountData(_creditAccount common.Address, priceUpdates []PriceOnDemand) (CreditAccountData, error) {
	return _DataCompressorv3.Contract.GetCreditAccountData(&_DataCompressorv3.CallOpts, _creditAccount, priceUpdates)
}

// GetCreditAccountData is a free data retrieval call binding the contract method 0xe50b35ec.
//
// Solidity: function getCreditAccountData(address _creditAccount, (address,bytes)[] priceUpdates) view returns((bool,address[],address,address,address,address,address,uint256,uint256,uint256,uint128,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,(address,uint256,bool,bool,bool,uint256,uint16)[],uint64,uint256,uint40,address[],uint256,(uint8,uint40,address,uint256)[2]) result)
func (_DataCompressorv3 *DataCompressorv3CallerSession) GetCreditAccountData(_creditAccount common.Address, priceUpdates []PriceOnDemand) (CreditAccountData, error) {
	return _DataCompressorv3.Contract.GetCreditAccountData(&_DataCompressorv3.CallOpts, _creditAccount, priceUpdates)
}

// GetCreditManagerData is a free data retrieval call binding the contract method 0xae093f3f.
//
// Solidity: function getCreditManagerData(address _pool) view returns((address,uint256,address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,address[],(address,address)[],uint256[],bool,address,uint256,uint8,uint16,uint16,uint16,uint16,uint16,(address,uint16,uint16,uint96,uint96)[],(address,uint16,uint16,uint16,uint16,uint16,uint16),bool) result)
func (_DataCompressorv3 *DataCompressorv3Caller) GetCreditManagerData(opts *bind.CallOpts, _pool common.Address) (CreditManagerData, error) {
	var out []interface{}
	err := _DataCompressorv3.contract.Call(opts, &out, "getCreditManagerData", _pool)
...
//
// Solidity: function getCreditManagerData(address _pool) view returns((address,uint256,address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,address[],(address,address)[],uint256[],bool,address,uint256,uint8,uint16,uint16,uint16,uint16,uint16,(address,uint16,uint16,uint96,uint96)[],(address,uint16,uint16,uint16,uint16,uint16,uint16),bool) result)
func (_DataCompressorv3 *DataCompressorv3Session) GetCreditManagerData(_pool common.Address) (CreditManagerData, error) {
	return _DataCompressorv3.Contract.GetCreditManagerData(&_DataCompressorv3.CallOpts, _pool)
}

// GetCreditManagerData is a free data retrieval call binding the contract method 0xae093f3f.
//
// Solidity: function getCreditManagerData(address _pool) view returns((address,uint256,address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,address[],(address,address)[],uint256[],bool,address,uint256,uint8,uint16,uint16,uint16,uint16,uint16,(address,uint16,uint16,uint96,uint96)[],(address,uint16,uint16,uint16,uint16,uint16,uint16),bool) result)
func (_DataCompressorv3 *DataCompressorv3CallerSession) GetCreditManagerData(_pool common.Address) (CreditManagerData, error) {
	return _DataCompressorv3.Contract.GetCreditManagerData(&_DataCompressorv3.CallOpts, _pool)
}

// GetCreditManagersV3List is a free data retrieval call binding the contract method 0xc7fd2b45.
//
// Solidity: function getCreditManagersV3List() view returns((address,uint256,address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,address[],(address,address)[],uint256[],bool,address,uint256,uint8,uint16,uint16,uint16,uint16,uint16,(address,uint16,uint16,uint96,uint96)[],(address,uint16,uint16,uint16,uint16,uint16,uint16),bool)[] result)
...
// GetGaugeVotes is a free data retrieval call binding the contract method 0xa83038d0.
//
// Solidity: function getGaugeVotes(address staker) view returns((address,address,uint96,uint96)[] gaugeVotes)
func (_DataCompressorv3 *DataCompressorv3Caller) GetGaugeVotes(opts *bind.CallOpts, staker common.Address) ([]GaugeVote, error) {
	var out []interface{}
	err := _DataCompressorv3.contract.Call(opts, &out, "getGaugeVotes", staker)

	if err != nil {
		return *new([]GaugeVote), err
	}

	out0 := *abi.ConvertType(out[0], new([]GaugeVote)).(*[]GaugeVote)
...
//
// Solidity: function getGaugeVotes(address staker) view returns((address,address,uint96,uint96)[] gaugeVotes)
func (_DataCompressorv3 *DataCompressorv3Session) GetGaugeVotes(staker common.Address) ([]GaugeVote, error) {
	return _DataCompressorv3.Contract.GetGaugeVotes(&_DataCompressorv3.CallOpts, staker)
}

// GetGaugeVotes is a free data retrieval call binding the contract method 0xa83038d0.
//
// Solidity: function getGaugeVotes(address staker) view returns((address,address,uint96,uint96)[] gaugeVotes)
func (_DataCompressorv3 *DataCompressorv3CallerSession) GetGaugeVotes(staker common.Address) ([]GaugeVote, error) {
	return _DataCompressorv3.Contract.GetGaugeVotes(&_DataCompressorv3.CallOpts, staker)
}

// GetGaugesV3Data is a free data retrieval call binding the contract method 0x32abad3c.
//
// Solidity: function getGaugesV3Data() view returns((address,(address,uint16,uint16,uint96,uint96,uint16,uint16,uint96,uint96)[])[] result)
func (_DataCompressorv3 *DataCompressorv3Caller) GetGaugesV3Data(opts *bind.CallOpts) ([]GaugeInfo, error) {
	var out []interface{}
	err := _DataCompressorv3.contract.Call(opts, &out, "getGaugesV3Data")
...
//
// Solidity: function getGaugesV3Data() view returns((address,(address,uint16,uint16,uint96,uint96,uint16,uint16,uint96,uint96)[])[] result)
func (_DataCompressorv3 *DataCompressorv3Session) GetGaugesV3Data() ([]GaugeInfo, error) {
	return _DataCompressorv3.Contract.GetGaugesV3Data(&_DataCompressorv3.CallOpts)
}

// GetGaugesV3Data is a free data retrieval call binding the contract method 0x32abad3c.
//
// Solidity: function getGaugesV3Data() view returns((address,(address,uint16,uint16,uint96,uint96,uint16,uint16,uint96,uint96)[])[] result)
func (_DataCompressorv3 *DataCompressorv3CallerSession) GetGaugesV3Data() ([]GaugeInfo, error) {
	return _DataCompressorv3.Contract.GetGaugesV3Data(&_DataCompressorv3.CallOpts)
}

// GetPoolData is a free data retrieval call binding the contract method 0x13d21cdf.
//
// Solidity: function getPoolData(address _pool) view returns((address,address,address,uint256,uint256,uint256,uint256,uint256,(address,uint256,uint256,uint256)[],uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,(address,uint16,uint16,uint96,uint96)[],(address,uint16,uint16,uint16,uint16,uint16,uint16),bool) result)
...
//
// Solidity: function getPoolsV3List() view returns((address,address,address,uint256,uint256,uint256,uint256,uint256,(address,uint256,uint256,uint256)[],uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,(address,uint16,uint16,uint96,uint96)[],(address,uint16,uint16,uint16,uint16,uint16,uint16),bool)[] result)
...
//
// Solidity: function getCreditAccountsByBorrower(address borrower, (address,bytes)[] priceUpdates) returns((bool,address[],address,address,address,address,address,uint256,uint256,uint256,uint128,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,(address,uint256,bool,bool,bool,uint256,uint16)[],uint64,uint256,uint40,address[],uint256,(uint8,uint40,address,uint256)[2])[] result)
...
//
// Solidity: function getCreditAccountsByCreditManager(address creditManager, (address,bytes)[] priceUpdates) returns((bool,address[],address,address,address,address,address,uint256,uint256,uint256,uint128,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,(address,uint256,bool,bool,bool,uint256,uint16)[],uint64,uint256,uint40,address[],uint256,(uint8,uint40,address,uint256)[2])[] result)
...
//
// Solidity: function getLiquidatableCreditAccounts((address,bytes)[] priceUpdates) returns((bool,address[],address,address,address,address,address,uint256,uint256,uint256,uint128,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,(address,uint256,bool,bool,bool,uint256,uint16)[],uint64,uint256,uint40,address[],uint256,(uint8,uint40,address,uint256)[2])[] result)
