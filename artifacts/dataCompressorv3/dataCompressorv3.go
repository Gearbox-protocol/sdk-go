...
//
// Solidity: function getCreditAccountData(address _creditAccount, (address,bytes)[] priceUpdates) view returns((bool,address[],address,address,address,string,address,address,uint256,uint256,uint256,uint128,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,(address,uint256,bool,bool,bool,uint256,uint16)[],uint64,uint256,uint40,address[],uint256,(uint8,uint40,address,uint256)[2]) result)
