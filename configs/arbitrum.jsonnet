{
  ...
  exchanges: {
    ...
    CURVE_USDE_USDC_POOL_ARB: '0x1c34204FCFE5314Dcf53BE2671C02c35DB58B4e3',
    ...
    AURA_CBETH_RETH_WSTETH_POOL_ARB: '0x8cA64Bd82AbFE138E195ce5Cb7268CA285D42245',
  ...
  names: {
    ...
    '2CRV': 'Curve 2CRV',
    '3c-crvUSD': 'Curve TriCrypto crvUSD',
    crvUSDC: 'Curve crvUSD/USDC LP (Arbitrum)',
    crvUSDT: 'Curve crvUSD/USDT LP (Arbitrum)',
    crvUSDC_e: 'Curve crvUSD/USDC_e LP (Arbitrum)',
    USDEUSDC: 'Curve USDe/USDC LP (Arbitrum)',
    cvxcrvUSDT: 'Convex crvUSDT vault (Arbitrum)',
    rsETH_wETH_Arb: 'Balancer rsETH/WETH Pool (Arbitrum)',
    wstETH_WETH_BPT: 'Balancer wstETH/WETH Pool (Arbitrum)',
    wstETH_rETH_sfrxETH: 'Balancer wstETH/rETH/sfrxETH Pool (Arbitrum)',
    wstETH_rETH_cbETH: 'Balancer wstETH/rETH/cbETH Pool (Arbitrum)',
    cbETH_rETH_wstETH: 'Balancer wstETH/rETH/cbETH Pool (Arbitrum)',
    rETH_WETH_BPT_deprecated: 'Balancer rETH/WETH Pool (Arbitrum)',
    rETH_wETH_BPT: 'Balancer rETH/WETH Pool (Arbitrum)',
    '33AURA_33ARB_33BAL': 'Balancer AURA/ARB/BAL Pool (Arbitrum)',
    ezETH_wstETH: 'Balancer ezETH/wstETH (Arbitrum)',
    aDAI: 'AaveV2 aDAI',
    aUSDC: 'AaveV2 aUSDC',
    aUSDT: 'AaveV2 aUSDT',
    aWETH: 'AaveV2 aWETH',
    aurawstETH_WETH_BPT: 'Balancer (Arbitrum) wstETH-WETH Aura Deposit',
    aurawstETH_rETH_sfrxETH: 'Balancer (Arbitrum) wstETH-rETH-sfrxETH Aura Deposit',
    auracbETH_rETH_wstETH: 'Balancer (Arbitrum) wstETH-rETH-cbETH Aura Deposit',
    aurarETH_wETH_BPT: 'Balancer (Arbitrum) rETH-WETH Aura Deposit',
    aurawstETH_WETH_BPT_vault: 'Balancer (Arbitrum) wstETH-WETH Aura Vault',
    aurawstETH_rETH_sfrxETH_vault: 'Balancer (Arbitrum) wstETH-rETH-sfrxETH Aura Vault',
    auracbETH_rETH_wstETH_vault: 'Balancer (Arbitrum) wstETH-rETH-cbETH Aura Vault',
    aurarETH_wETH_BPT_vault: 'Balancer (Arbitrum) rETH-WETH Aura Vault',
    dUSDCV3: 'dUSDCV3',
    dUSDC_eV3: 'dUSDC.eV3',
    dWETHV3: 'dWETHV3',
    sdUSDCV3: 'sdUSDCV3',
  ...
  compositeRedstone: {
    ...
    rsETH: {
      ...
      dataId: 'rsETH/ETH',
      signersThreshold: 5,
      token: '0x15094B05e679c9B7fDde6FB8e6BDa930ff1D6a62',
    },
  },
}
