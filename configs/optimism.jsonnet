{
  ...
  names: {
    ...
    sfrxETH: 'sfrxETH',
    wstETHCRV: 'Curve wstETHCRV',
    '3CRV': 'Curve 3Crv',
    yvDAI: 'Yearn yvDAI',
    yvUSDC_e: 'Yearn yvUSDC.e',
    yvWETH: 'Yearn yvWETH',
    yvWBTC: 'Yearn yvWBTC',
    yvUSDT: 'Yearn yvUSDT',
    yvOP: 'Yearn yvOP',
    BPT_rETH_ETH: 'BeethovenX rETH-ETH Pool',
    BPT_WSTETH_ETH: 'BeethovenX wstETH-ETH Pool',
    BPT_ROAD: 'BeethovenX WETH-OP-USDC Pool',
    ECLP_wstETH_WETH: 'BeethovenX ECLP wstETH-ETH Pool',
    bpt_ethtri: 'Ethereum Triplets',
    auraBPT_rETH_ETH: 'BeethovenX rETH-ETH Aura Deposit',
    auraBPT_WSTETH_ETH: 'BeethovenX wstETH-ETH Aura Deposit',
    auraBPT_rETH_ETH_vault: 'Aura BPT_rETH_ETH vault',
    auraBPT_WSTETH_ETH_vault: 'Aura BPT_WSTETH_ETH vault',
    dUSDCV3: 'dUSDCV3',
    dUSDC_eV3: 'dUSDC.eV3',
    dWETHV3: 'dWETHV3',
    sdUSDCV3: 'sdUSDCV3',
